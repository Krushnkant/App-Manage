$(document).ready(function(){
	...
	$("#catIconFiles").filer({
		...
		onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            ...
            var removableFile = $("#catImg").val();
		    $.post(ImageUrl+'categories/removefile?action=removeCatIcon', {'_token': $('meta[name="csrf-token"]').attr('content'), file: removableFile});
			$("#catImg").removeAttr('value');
		},
		onEmpty: null,
		options: null,
		dialogs: {
