                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div class="todo-list">
                                        <div class="tdl-holder">
                                            ...
                                            <div class="px-4">
                                                <input type="text" class="tdl-new form-control" placeholder="Write new item and hit ..." />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset("user/assets/images/users/8.jpg")}}" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset("user/assets/images/users/5.jpg")}}" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset("user/assets/images/users/7.jpg")}}" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset("user/assets/images/users/1.jpg")}}" class="rounded-circle" alt="">
