                        ...
                        <form class="form-valide" action="" mathod="POST" id="content_add" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="title" placeholder="Field Name" class="form-control input-flat specReq" name="title" value="{{$formStructure->form_title}}" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="{{$name}}" value="{{$c_->field_value}}" id="{{$field_types->field_name}}" placeholder="enter your {{$field_types->field_name}}" class="form-control input-flat specReq" multiple/>
                                    </div>
                                    <div>
                                        @if(isset($multi_files) && count($multi_files) > 0)
                                        @foreach($multi_files as $file)
                                        <img src="{{asset('app_data_images/'.$file->field_value)}}" class="w-50" />
                                        @endforeach
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="col-form-label" for="name">{{$field_types->field_name}}</label>
                                        <input type="{{$field_types->field_type}}" value="{{$c_->field_value}}" name="{{$name}}" id="{{$field_types->field_name}}" placeholder="enter your {{$field_types->field_name}}" class="form-control input-flat specReq"/>
                                    </div>
                                    <div>
                                        <img src="{{asset('app_data_images/'.$c_->field_value)}}" class="w-50" />
                                    </div>
                                </div>
                                @else
                                <div class="col-lg-6">
