                                ...
                                <div class="col-md-10  col-xl-6">
                                    <div class="row">
                                        <div class="form-group col-9 col-sm-10 px-sm-0">
                                            <label class="col-12 col-form-label px-0 px-sm-3" for="name">Field Select: <span class="text-danger">*</span>
                                            </label>
        ...
        if(type == 'sub-form'){
           ...
           html += '<div class="row mt-3 mx-0">'+
                '<div class="form-group col-9 col-sm-10">'+
                    '<label class="col-lg-12 col-form-label pl-0" for="name">Field Select: <span class="text-danger">*</span></label>'+
