                                ...
                                <div class="col-md-10  col-xl-6">
                                    <div class="row">
                                        <div class="form-group col-9 col-sm-10 px-sm-0">
                                            <label class="col-12 col-form-label px-0 px-sm-3 pt-0" for="name">Field Select: <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div class="form-group col-3 px-0 px-sm-3 col-sm-2 text-center">
                                            <div class="ml-auto ">
                                                <button type="button" class="plus_btn btn mb-1 btn-info field_btn" id="Add">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        if(type == 'sub-form'){
            html += '<div class="row mt-3 mx-0">'+
                    ...
                    '<div class="col-2 col-sm-2 text-center">'+
                        '<button type="button"  class="minus_btn btn mb-1 btn-dark px-0"><img src="{{asset('user/assets/icons/delete-red.png')}}"></button>'+
                    '</div>'+
                '</div>';

           html += '<div class="row mt-0 mx-3 border px-3 py-4 sub-form-card">'+
                '<div class="form-group col-9 col-sm-10">'+
                    '<label class="col-lg-12 col-form-label pl-0 pt-0" for="name">Field Select: <span class="text-danger">*</span></label>'+
                    '<div class="col-lg-12 px-0">'+
                        ...
                        '<select class="form-control select-box mb-3 mb-sm-0" id="field-subform" name="field-subform">'+
                            '<option value="">---Select---</option>'+
            ...
            html += '<div class="row mt-3 mx-0">'+
                    ...
                    '</div>'+
                    '<div class="col-10 col-sm-5 mb-3 mb-sm-0">'+
                        '<input type="text" value="'+type+'" class="form-control input-flat pe-none" name="field_type[]"  />'+
                    '</div>'+
                    '<div class="col-2 col-sm-2 text-center">'+
                        '<button type="button"  class="minus_btn btn mb-1 btn-dark px-0"><img src="{{asset('user/assets/icons/delete-red.png')}}"></button>'+
